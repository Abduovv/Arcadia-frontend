...
export const Footer = () => (
    <footer className="mt-24 border-t border-border/30">
        ...
        <div className="container py-10 md:py-14 text-center">
            <p className="font-display text-2xl md:text-3xl font-semibold tracking-[-0.02em] text-foreground/85 max-w-2xl mx-auto leading-tight">
                Replaces trust with performance.
                <br />
                <span className="text-gradient-signal">Built on Solana.</span>
            </p>
            <p className="mt-4 text-sm text-muted-foreground max-w-md mx-auto">
                Non-custodial vaults with verifiable track records. Traders earn fees by proving
                skill, not by collecting promises.
            </p>
        </div>
            ...
            <div className="container py-8 grid grid-cols-2 md:grid-cols-5 gap-6">
                <div className="col-span-2">
                    <Link to="/" className="flex items-center gap-2 mb-3 w-fit">
                        ...
                        <ArcadiaWordmark className="text-[28px]" />
                    </Link>
        ...
        <div className="border-t border-border/20">
            <div className="container py-3 flex flex-col md:flex-row gap-1.5 justify-between text-[10px] text-muted-foreground font-mono">
                <span>2026 Molten Labs. Non-custodial.</span>
                <a
                ...
                >
                    Program: 49StrXrpxCyC...Nv9WcdN · devnet
                </a>
            </div>
        </div>
    </footer>
                ...
                <li key={l.label}>
                    {l.external ? (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[12px] text-foreground/65 hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:rounded-sm"
                        >
                            {l.label}
                        </a>
                    ) : (
